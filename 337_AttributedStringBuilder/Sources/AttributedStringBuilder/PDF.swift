...
extension CGFloat {
    static let pointsPerInch: Self = 72
    static var pointsPerMM: Self { pointsPerInch / 25.4 }
}

extension CGSize {
    static let a4 = CGSize(width: 8.25 * .pointsPerInch, height: 11.75 * .pointsPerInch)
}

extension NSAttributedString {
    func pdf(
        size: CGSize = .a4,
        inset: CGSize = CGSize(width: .pointsPerInch, height: .pointsPerInch)
    ) -> Data {
